...
⇒ The main objective was to forecast weekly sales for each department in 45  stores located in different regions and also to carry out statistical testing and          validation of the models
